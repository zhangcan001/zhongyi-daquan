...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::knowledge_commands::list_knowledge_versions,
            commands::knowledge_commands::get_knowledge_version,
            commands::knowledge_commands::compare_knowledge_versions,
            commands::knowledge_commands::rollback_knowledge_version,
