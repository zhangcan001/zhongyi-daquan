...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::ai_commands::clear_ai_api_key,
            ...
            commands::import_commands::execute_import_plan_background,
            ...
            commands::maintenance_commands::start_rebuild_search_index_job,
