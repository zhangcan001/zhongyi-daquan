...
fn field_alias(header: &str) -> Option<&'static str> {
    match header {
        ...
        "fourqi" | "四气" | "寒热温凉" | "寒热属性" => Some("four_qi"),
        "fiveflavors" | "五味" | "味" => Some("five_flavors"),
        "meridians" | "归经" | "经络" => Some("meridians"),
        "channeltropism" | "归经脏腑" | "归脏腑" | "入经" => Some("channel_tropism"),
        "toxicity" | "毒性" => Some("toxicity"),
        "origin" | "产地" | "来源产地" | "药材来源" => Some("origin"),
        ...
        "processing" | "炮制" => Some("processing"),
        "classicapplications" | "仲景" | "经方应用" | "经典应用" => {
            Some("classic_applications")
        }
